 ...
 *
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/temp/WeatherWebService.xml")
        ...
        extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/temp/WeatherWebService.xml");
