                            ...
                            <div class="scancode-tip clearfix">
                                ...
                                <div class="scan-note fr" style="margin-top: 10px;">
                                    <span class="note1">请使用</span> <a href="javascript:void(0);"
                                                                      class="note2" target="_blank">手机HForum</a><span
                                        class="note1">
										扫一扫登录</span>
                                </div>
                            </div>
                    ...
                    <div class="loginbox-bd loginbox-login" data-type="login">
                        ...
                        <div class="loginbox-bd-container">
                            ...
                            <form class="login-form login-by-phoneNum" action=""
                                ...
                                <!-- 手机号 -->
                                <div id="phoneNum-div" class="loginbox-p login-by-phoneNum login-by-sms" style="display: none">
                                ...
                                <!-- 邮箱 -->
                                <div id="email-div" class="loginbox-p login-by-nickname" style="display: block">
                                    <div class="loginbox-p-stype-item">
                                        <span class="ipt-span ipt1"></span>
                                        <input class="ipt" type="text" style="width:300px;height:35px;" name="username"
                                               placeholder="请输入邮箱">
                                    </div>
                                </div>
                                <!-- 密码框 -->
                                <div id="password-div" class="loginbox-p login-by-phoneNum login-by-nickname">
                                    <span class="ipt-span ipt2"></span> <input class="ipt"
                                                                               type="password" name="password"
                                                                               placeholder="输入密码"
                                                                               autocomplete="off"
                                                                               style="width:300px;height:35px;"> <input
                                        class="ipt showpw1 notsub"
                                        type="text" name="password" placeholder="输入密码"
                                        autocomplete="off" style="margin-top: -1px;"/> <span
                                        class="pw-span pw-hide pw-hide1"></span>
                                </div>
                                <div class="captcha-gt"></div>
                                <!-- 短信验证 -->
                                <div id="sms-div" class="loginbox-p login-by-sms">
                                    <div class="clearfix">
                                        <div class="form-field">
                                            <div class="clearfix">
                                                <input type="text" class="ipt fl loginbox-phone-yzp"
                                                       size="6" maxlength="6" style="width:205px;height:35px;" id="yzphonenum" name="phoneCaptcha"
                                ...
                                <div class="login-sbt-con">
                                    ...
                                    <div class="loginbox-noact clearfix">
                                        <a  href="javascript:void(0);" class="login-type-enter login-by-phoneNum"
                                           id="phone-login-a">手机快捷登录</a>
                                        <a id="email-login-a" href="javascript:void(0);" class="login-type-enter login-by-sms"
                                           data-subtype="login-by-phoneNum">邮箱登录</a>
