...
a+"</div>");methods.remove(".HTooltip");k.stop().append(e);clearTimeout(g);var g=setTimeout(function(){methods.remove(".HTooltip");void 0!=d&&methods.fire.call(this,d)},b)},goTop:function(a,b){a=void 0!=a?a:"180px";b=void 0!=b?b:"30px";methods.remove("#HGoTop");k.stop().append('<a id="HGoTop" href="javascript:;" style="width:50px;height:50px;line-height:50px;border-radius:50%;display:inline-block;text-align:center;background:#333;color:#fff;position:fixed;bottom:'+a+";right:"+b+';z-index:100000;"><i class="layui-icon" style="font-size: 30px; color: #FFFFFF;">&#xe604;</i></a>').find("#HGoTop").hide();
